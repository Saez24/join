...
/**
 * Generates HTML for assigned names.
 * 
...
/**
 * Generates HTML for subtask count.
 * 
 * @function generateSubtaskCountHTML
 * @param {Object[]} [subtask] - An array of subtasks.
 * @returns {string} HTML string representing the subtask count.
 */
...
function createTaskHTML(task, taskid, assignedNamesHTML, subtaskCountHTML, priorityImage, categoryColor) {
    return /*html*/`
        <div id="${taskid}" draggable="true" ondragstart="startDragging('${taskid}')" class="toDoBox" onclick="showPopup('popup')">
